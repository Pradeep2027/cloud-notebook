    ...
    <>
      <form onSubmit={handleSubmit}>
        ...
        <div className="row g-3 align-items-center mb-3">
          ...
          <div className="col-auto">
            <input type="password" className="form-control" id="password" name="password" aria-describedby="passwordHelp" onChange={onChange} />
          </div>
          <div className="col-auto">
        ...
        <div className="row g-3 align-items-center mb-3">
          ...
          <div className="col-auto">
            <input type="password" className="form-control" id="confirmPassword" name="confirmPassword" aria-describedby="passwordHelp" onChange={onChange} />
          </div>
          <div className="col-auto">
            <span id="passwordHelp" className="form-text"> Must be more than 5 characters long. </span>
          </div>
